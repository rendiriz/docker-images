...
if [[ "$C3_KSQLDB_HTTPS" == "false" ]]; then
  export CONTROL_CENTER_KSQL_DB_URL="http://ksqldb-server:8088"
  export CONTROL_CENTER_KSQL_DB_ADVERTISED_URL="http://localhost:8088"
  C3URL=http://localhost:9021
else
  export CONTROL_CENTER_KSQL_DB_URL="https://ksqldb-server:8089"
  export CONTROL_CENTER_KSQL_DB_ADVERTISED_URL="https://localhost:8089"
...
if [[ -n "${GITPOD_WORKSPACE_URL:-}" ]]; then
  ...
  export CONTROL_CENTER_KSQL_DB_URL="http://ksqldb-server:8088"
  export CONTROL_CENTER_KSQL_DB_ADVERTISED_URL="https://8088-${GITPOD_WORKSPACE_URL#https://}"
