...
# Generate CA key
openssl req -new -x509 -keyout snakeoil-wj-1.key -out snakeoil-wj-1.crt -days 365 -subj '/CN=wj1.test.kitabikin.com/OU=TEST/O=KITABIKIN/L=Bandung/ST=WJ/C=ID' -passin pass:confluent -passout pass:confluent
